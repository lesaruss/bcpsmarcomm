...
export default function WCMRegistrationWelcomePage() {
  useEffect(() => {
      ...
      <div className="wp-stage">
        <section className="wp-step wp-active wp-center">
          <div className="wp-cover-band">
            ...
            />
            <span className="wp-eyebrow">WCM Department Registration</span>
            <h1>Welcome to Web Content Manager Department Registration</h1>
        ...
        <section className="wp-step">
          ...
          <p className="wp-lead" style={{ marginTop: 14 }}>
            Creating your account enrolls you as a Department Web Content Manager, this
        ...
        <section className="wp-step wp-center">
          ...
          <p className="wp-lead" style={{ margin: '14px auto 0', maxWidth: '48ch' }}>
            Complete your Web Content Manager Department Registration. Access restricted to @browardschools.com
            addresses.
          </p>
          <a href="/wcm-registration/register" className="wp-cta-btn">Create Your Account</a>
