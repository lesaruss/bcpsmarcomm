...
export default function WCMRegistrationRegisterPage() {
        ...
        <div style={styles.wrap}>
          {step === 'intro' && (
            <div style={styles.card}>
              <p style={styles.eyebrow}>WCM Department Registration</p>
              <h1 style={styles.title}>Before You Register</h1>
              <p style={styles.body}>
                Creating your account enrolls you as a Department Web Content Manager. Here is what happens next.
              </p>
